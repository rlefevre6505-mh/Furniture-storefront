...
export default function ShopPage() {
  ...
  const [sort, setSort] = useState("lowest"); // sort by price, highest first by default
  ...
  useEffect(() => {
    if (sort === "lowest") {
      const reverseSortedProducts = showItems.sort((a, b) => b.price - a.price);
      setShowItems([...reverseSortedProducts]);
    }
    if (sort === "highest") {
      const sortedProducts = showItems.sort((a, b) => a.price - b.price);
